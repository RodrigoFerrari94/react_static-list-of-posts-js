...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>D.jsxs("div",{className:"CommentInfo",children:[D.jsxs("div",{className:"CommentInfo__title",children:[D.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",D.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),D.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>D.jsx("div",{className:"CommentList",children:e.map(t=>D.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>D.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>D.jsxs("div",{className:"PostInfo",children:[D.jsxs("div",{className:"PostInfo__header",children:[D.jsx("h3",{className:"PostInfo__title",children:e.title}),D.jsxs("p",{children:[" Posted by  ",e.user&&D.jsx(Tc,{user:e.user})]})]}),D.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length===0?D.jsxs(D.Fragment,{children:[D.jsx("hr",{}),D.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}):D.jsx(Lc,{comments:e.comments})]}),Dc=({posts:e})=>D.jsx("div",{className:"PostList",children:e.map(t=>D.jsx(Mc,{post:t},t.id))}),Rc=e=>Nc.find(t=>t.id===e)||null,jc=e=>zc.filter(t=>t.postId===e),Oc=Cc.map(e=>({...e,user:Rc(e.userId),comments:jc(e.id)})),Fc=()=>D.jsxs("section",{className:"App",children:[D.jsx("h1",{className:"App__title",children:"Static list of posts"}),D.jsx(Dc,{posts:Oc})]});em(document.getElementById("root")).render(D.jsx(Fc,{}));
